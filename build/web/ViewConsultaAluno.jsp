<%-- 
    Document   : ViewConsultaAluno
    Created on : 05/09/2018, 20:51:05
    Author     : Roberto Oswaldo Klann
--%>

<%@page import="Controller.Aluno"%>
<%@page import="Modelo.AlunoModel"%>
            ...
            <table class="table table-striped">
                <tr>
                 ...
                 <%
                    ...
                    ArrayList lista = Aluno.getAlunos(conexao);
                    for(int i=0; i < lista.size(); i++){
                        AlunoModel aluno = (AlunoModel) lista.get(i);                
                 %>
                    <tr>
                        ...
                        <td>
                            <a href="excluicidade.jsp?codigo=<%=aluno.getCodigo()%>">Excluir</a>
                            -
                            <a href="alteracidade.jsp?codigo=<%=aluno.getCodigo()%>">Alterar</a>
                        </td>
                    </tr>
                <%
                    }        
