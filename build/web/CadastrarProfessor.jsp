<%-- 
    ...
    Created on : 05/09/2018, 21:14:57
    Author     : 40249
--%>
                ...
                <div class = "container">
                    <div class = "container">
                        <div class="form-group">
                            <label for="procodigo">Código Professor</label>
                            <input type="number" class="form-control" name="procodigo" placeholder="Código do Professor">
                        </div>
                        <div class="form-group">
                            <label for="pronome">Nome do Aluno</label>
                            <input type="text" class="form-control" name="pronome" placeholder="Nome">
                        </div>
                        <div class="form-group">
                            <label for="prograduacao">Graduação</label>
                            <input type="text" class="form-control" name="prograduacao" placeholder="Graduação">
                        </div>
                    </div>
                </div>
