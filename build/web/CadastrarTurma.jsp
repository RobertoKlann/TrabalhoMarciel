<%-- 
    ...
    Created on : 05/09/2018, 21:15:10
    Author     : 40249
--%>
                ...
                <div class = "container">
                    <div class = "container">
                        <div class="form-group">
                            <label for="turcodigo">Código Turma</label>
                            <input type="number" class="form-control" name="turcodigo" placeholder="Código do Turma">
                        </div>
                        <div class="form-group">
                            <label for="curcodigo">Código do Curso</label>
                            <input type="number" class="form-control" name="curcodigo" placeholder="Código Curso">
                        </div>
                        <div class="form-group">
                            <label for="procodigo">Código do Professor</label>
                            <input type="number" class="form-control" name="procodigo" placeholder="Código Professor">
                        </div>
                        <div class="form-group">
                            <label for="turdatafim">Data de termino da Turma</label>
                            <input type="number" class="form-control" name="turdatafim" placeholder="01/01/2018">
                        </div>
                        <div class="form-group">
                            <label for="turdatainicio">Data de Inicio da Turma</label>
                            <input type="number" class="form-control" name="turdatainicio" placeholder="01/01/2018">
                        </div>
                        <div class="form-group">
                            <label for="turhorario">Horário da Turma</label>
                            <input type="number" class="form-control" name="turhorario" placeholder="18:50 - 22:00">
                        </div>
                    </div>
                </div>
