<%-- 
    Document   : ViewConsultaCurso
    Created on : 05/09/2018, 20:54:32
            ...
            <table class="table table-striped">
                <tr>
                 ...
                 <%
                    ...
                    ArrayList lista    = Curso.getCursos(conexao);
                    for(int i=0; i < lista.size(); i++){
                        CursoModel curso = (CursoModel) lista.get(i);                
                 %>
                    <tr>
                        ...
                        <td>
                            <a href="excluicidade.jsp?codigo=<%=curso.getCodigo()%>">Excluir</a>
                            -
                            <a href="alteracidade.jsp?codigo=<%=curso.getCodigo()%>">Alterar</a>
                        </td>
                    </tr>
                <%
                    }        
