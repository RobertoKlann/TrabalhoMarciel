<%-- 
    ...
    Created on : 05/09/2018, 21:15:24
    Author     : 40249
--%>
                ...
                <div class = "container">
                    <div class = "container">
                        <div class="form-group">
                            <label for="curcodigo">Código Curso</label>
                            <input type="number" class="form-control" name="curcodigo" placeholder="Ex: 01">
                        </div>
                        <div class="form-group">
                            <label for="curdescricao">Descrição do Curso</label>
                            <input type="text" class="form-control" name="curdescricao" placeholder="Ex: Sistemas de Informação">
                        </div>
                        <div class="form-group">
                            <label for="curduracao">Duração do Curso</label>
                            <input type="text" class="form-control" name="curduracao" placeholder="Ex: 2 anos">
                        </div>
                    </div>
                </div>
