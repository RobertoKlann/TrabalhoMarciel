<%-- 
    Document   : ViewConsultaProfessor
    Created on : 05/09/2018, 20:53:57
...
<%@page import="Modelo.ProfessorModel"%>
            ...
            <table class="table table-striped">
                <tr>
                 ...
                 <%
                    ...
                    ArrayList lista = Professor.getProfessores(conexao);
                    for(int i=0; i < lista.size(); i++){
                        ProfessorModel professor = (ProfessorModel) lista.get(i);                
                 %>
                    <tr>
                        <td><%=professor.getCodigo()%></td>
                        <td><%=professor.getNome()%></td>
                        <td><%=professor.getGraduacao()%></td>
                        <td>
                            <a href="excluicidade.jsp?codigo=<%=professor.getCodigo()%>">Excluir</a>
                            -
                            <a href="alteracidade.jsp?codigo=<%=professor.getCodigo()%>">Alterar</a>
                        </td>
                    </tr>
                <%
                    }        
